										...
										if (resultArray[0]=='FAILED'){
											...
											//------------- Visit Plan Market List / Client Profile Market List / Unschedule
													...
													for (var k=0; k < planMarketListShowLength; k++){
														...
														//alert (marketNameID);
														if(planMarketID!=''){
															unscheduleMarketComb+='<li class="ui-btn ui-shadow ui-corner-all ui-btn-icon-left ui-icon-location" style="border-bottom-style:solid; border-color:#CBE4E4;border-bottom-width:thin"><a onClick="marketNext_doc(\''+marketNameID+'\')">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+marketNameID+'</a></li>';
					...
					if ((doc_result== undefined) || (doc_result== 'undefined')){
						...
						for ( i=0; i < mClientListShowLength; i++){
							...
							if(mClientID!=''){
								...
								unscheduled_m_client_list+='<li class="ui-btn ui-shadow ui-corner-all ui-btn-icon-left ui-icon-location" style="border-bottom-style:solid; border-color:#CBE4E4;border-bottom-width:thin"><a onClick="marketRetailerNext_doc(\''+mClientName+'|'+mClientID+'\')">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+mClientName+'|'+mClientID+'</a></li>';
								}								
						}
						...
						//localStorage.scheduled_date=scheduled_date
									...
									//------- 
									$.afui.loadContent("#page_doctor",true,true);
...
//			===============================
		...
		$.afui.loadContent("#page_doctor_campaign",true,true);
...
function getDocCampaignData(){	
	$.afui.loadContent("#page_prescription",true,true);		
	}
									...
									$("#btn_prescription_submit").show();
									   ...
									   var resultArray = data.split('<SYNCDATA>');	
										if (resultArray[0]=='FAILED'){						
											...
											$.afui.loadContent("#page_success",true,true);
